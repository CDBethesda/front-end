      ...
      <nav className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
                ...
                <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                  ...
                  <li className="items-center">
                    <Link
                      className={
                        "text-xs uppercase py-3 font-bold block " +
                        (window.location.href.indexOf("/admin/datadokter") !==
                          -1
                          ? "text-blue-500 hover:text-blue-600"
                          : "text-slate-700 hover:text-slate-500")
                      }
                  ...
                  <li className="items-center">
                    <Link
                      className={
                        "text-xs uppercase py-3 font-bold block " +
                        (window.location.href.indexOf("/admin/rekammedis") !==
                          -1
                          ? "text-blue-500 hover:text-blue-600"
                          : "text-slate-700 hover:text-slate-500")
                      }
                  ...
                  <li className="items-center">
                    <Link
                      className={
                        "text-xs uppercase py-3 font-bold block " +
                        (window.location.href.indexOf("/admin/appointment") !==
                          -1
                          ? "text-blue-500 hover:text-blue-600"
                          : "text-slate-700 hover:text-slate-500")
                      }
            ...
            {localStorage.getItem("role") === "pasien" ? (
              <>
                {" "}
                {/* Heading */}
                <h6 className="md:min-w-full text-slate-500 text-xs uppercase font-bold block pt-1 pb-4 no-underline">
                  ...
                  <li className="items-center">
                    <Link
                      className={
                        "text-xs uppercase py-3 font-bold block " +
                        (window.location.href.indexOf(
                          "/admin/history-appointment"
                        ) !== -1
                          ? "text-blue-500 hover:text-blue-600"
                          : "text-slate-700 hover:text-slate-500")
                      }
                      to="/admin/history-appointment"
                    >
                      <i
                        className={
                          "fas fa-table mr-2 text-sm " +
                  ...
                  <li className="items-center">
                    <Link
                      className={
                        "text-xs uppercase py-3 font-bold block " +
                        (window.location.href.indexOf(
                          "/admin/histor-preception"
                        ) !== -1
                          ? "text-blue-500 hover:text-blue-600"
                          : "text-slate-700 hover:text-slate-500")
                      }
                      to="/admin/histor-preception"
                    >
                      <i
                        className={
                          "fas fa-table mr-2 text-sm " +
